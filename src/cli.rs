...
/// локально созданным корнем с расширением X.509 nameConstraints, и
/// доверие выдаётся только локальному корневому сертификату.
/// 
...
///
///   rucerts init --cn "My Russian Root"  создать локальный корневой сертификат
